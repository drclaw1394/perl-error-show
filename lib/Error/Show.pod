...
B<start_mark> option), which will actually be classed as the minimum line
number of the file
...
the B<end_mark> option), which will actually be classed as the maximum line
number of the file.
