...
It has a syntax error on line 13, and uses an experimental feature on line 5.
...
nicely formatted context is dumped on STDERR for you to see the error or your
ways. 

The resulting output is optionally filtered through the [splain](https://metacpan.org/pod/splain) program, with
no effort on the users behalf to give more information on why syntax errors and
warnings might have occurred. 
